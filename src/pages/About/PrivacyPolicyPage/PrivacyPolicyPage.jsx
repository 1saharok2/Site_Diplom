        ...
        <Box sx={{ '& > section': { mb: 4 } }}>
          <section>
            ...
            <Typography variant="body1" paragraph>
              Настоящая Политика конфиденциальности (далее — Политика) действует в отношении всей информации, которую интернет-магазин «Магазин электроники», расположенный на доменном имени https://electronic.tw1.ru, может получить о Пользователе во время использования сайта Магазина, его услуг, программ и продуктов.
            </Typography>
          </section>
